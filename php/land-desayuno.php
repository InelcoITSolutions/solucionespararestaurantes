...
if (isset($_POST["g-recaptcha-response"]) && $_POST["g-recaptcha-response"]){
	...
	$email_to = "contacto@solucionespararestaurantes.mx";//$email_to = "contacto@solucionespararestaurantes.mx";
		...
		<body style="font-family: sans-serif; color: #555; font-size: 1.2em">
			...
			<div style="margin-bottom: 2em">
				...
				<p style="text-align: center"><b>Jueves 25</b> de agosto a las <b>09:30 hrs</b></p>
				<p style="text-align: center">en las instalaciones de: </p>
				<p style="text-align: center">Four Points by Shareton, ubicadas en:</p>
				<br>
				<p style="text-align: center">A.v. Miguel Alemán No. 6064 Col. Torres de Linda Vista</p>
				<p style="text-align: center">67138  Guadalupe, Nuevo León</p>
	...
	$resultado = mysql_query("SELECT * FROM usuarios_desayuno WHERE email LIKE '%$correo%'", $conexion); 
	...
	if ($row = mysql_fetch_array($resultado)){
		echo '<script language="javascript">
			...
			if ($conteo = $mysqli->query("SELECT * FROM usuarios_desayuno ORDER BY nombre")) {
		...
		$sql="INSERT INTO usuarios_desayuno "."(Nombre, Correo, Telefono, Empresa, Interesado, Estado) VALUES ('$nombre', '$correo', '$tel', '$empresa','Desayuno Comercial Soft Restaurant', '$estado')";	
		...
		echo '<script language="javascript">
			...
			location.href="http://solucionespararestaurantes.mx/invitacion#reg";
			</script>'; 
	}
