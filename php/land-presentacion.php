    ...
    $contenido = '
		...
		<body style="font-family: sans-serif; color: #555; font-size: 1.2em">
			...
			<div style="margin-bottom: 2em">
				...
				<p style="text-align: center"><b>miércoles 14</b> de septiembre a las <b>11:00 hrs</b></p>
				<p style="text-align: center">en las instalaciones de: </p>
				<p style="text-align: center">Inelco IT Solutions, ubicadas en:</p>
				<br>
				<p style="text-align: center">Av. Fundidora N° 501 Int. 18 Edificio Cintermex</p>
				<p style="text-align: center">64010 Monterrey, Nuevo León</p>
