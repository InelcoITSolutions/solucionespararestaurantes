...
if (isset($_POST["g-recaptcha-response"]) && $_POST["g-recaptcha-response"]){
	...
	if ($row = mysql_fetch_array($resultado)){
		echo '<script language="javascript">
			...
			$conteo = mysql_query("SELECT count(*) from user_presentacion;", $conexion);
			if ($conteo>20) {
				$estado='En espera';
				echo "<br><br>Ya no hay suficientes espacios: el conteo es de  $conteo<br><br>";	
			}else{
				$estado='Aceptado';
				echo "<br><br>hay $conteo de usuarios registrados<br><br>";
			}
