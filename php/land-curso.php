...
if (isset($_POST["g-recaptcha-response"]) && $_POST["g-recaptcha-response"]){
	...
	$email_to = "contacto@solucionespararestaurantes.mx";//$email_to = "contacto@solucionespararestaurantes.mx";
		...
		<body style="font-family: sans-serif; color: #555; font-size: 1.2em">
			...
			<div style="margin-bottom: 2em">
				...
				<p style="text-align: center">Agradece tu registro para nuestro curso en línea de: </p>

				<p style="text-align: center; font-weight: bold"><span style="color: #CB6220">“Tips de administración y control de inventarios”</span></p>
				<br>
				<p style="text-align: center">Te esperamos el </p>
				<p style="text-align: center"><b>miercoles 17</b> de agosto a las <b>16:00 hrs</b></p>
				<p style="text-align: center">En breve te enviaremos el link de acceso a la conferencia</p>
	...
	$resultado = mysql_query("SELECT * FROM usuarios_curso WHERE Correo LIKE '%$correo%'", $conexion); 
	...
	if ($row = mysql_fetch_array($resultado)){
		echo '<script language="javascript">
			...
			if ($conteo = $mysqli->query("SELECT * FROM usuarios_curso ORDER BY Nombre")) {
		...
		$sql="INSERT INTO usuarios_curso "."(Nombre, Correo, Telefono, Empresa, Interesado, Estado) VALUES ('$nombre', '$correo', '$tel', '$empresa','Curso Soft Restaurant', '$estado')";	
