<?php
	if (isset($_POST["g-recaptcha-response"]) && $_POST["g-recaptcha-response"]){
		...
		$contenido = "Se ha enviado un mensaje desde la pagina solucionespararestaurantes.mx\n"
		. "\n"
		. "Nombre: $nombre\n"
		. "Email: $email\n"
		. "Telefono: $tel\n"
		...
		location.href="http://www.solucionespararestaurantes.mx/index.html";
		</script>'; 
		...
		echo '<script language="javascript">
			...
			location.href="http://solucionespararestaurantes.mx/contactopromo";
			</script>'; 
	}
?>