<?php
 ...
 $start_play                = onetone_option("section_youtube_start",3);
  ...
  $background_video  = array("videoId"=>$section_background_video, "start"=>$start_play ,"mute"=>false,"container" =>"section.onetone-youtube-section","playerid"=>"onetone-youtube-section",'video_full_screen' => $video_full_screen);
